...
| GGML_SYCL_ENABLE_GRAPH | 0 (default) or 1 | Enable running computations through SYCL Graphs feature. Requires also the code be be compiled with GGML_SYCL_GRAPH=ON. |
